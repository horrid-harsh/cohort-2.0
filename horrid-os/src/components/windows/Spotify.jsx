...
const Spotify = ({ windowName, setWindowsState, topZIndex, setTopZIndex }) => {
  return (
    <MacWindow windowName={windowName} setWindowsState={setWindowsState} topZIndex={topZIndex} setTopZIndex={setTopZIndex} width='20vw'>
